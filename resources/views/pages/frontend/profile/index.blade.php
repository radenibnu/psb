                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ url('profile') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="nohp" type="text" class="form-control @error('handphone') is-invalid @enderror" name="handphone" value="{{ $user->handphone }}" required autocomplete="handphone" autofocus>
